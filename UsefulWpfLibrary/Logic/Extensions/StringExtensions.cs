...
namespace UsefulWpfLibrary.Logic.Extensions
{
    public static class StringExtensions
    {
        ...
        {
            _ = MessageWindowTools.Show(s, messageType: MessageType.错误);
        }

        public static void ShowErrorMessageBox(this string s)
        {
            _ = MessageBox.Show(s, "错误", MessageBoxButton.OK, MessageBoxImage.Error);
        }

        public static void ShowInfoMessage(this string s)
        {
            _ = MessageWindowTools.Show(s, messageType: MessageType.信息);
        }

        public static void ShowInfoMessageBox(this string s)
        {
            _ = MessageBox.Show(s, "信息", MessageBoxButton.OK, MessageBoxImage.Information);
        }

        public static void ShowWarningMessage(this string s)
        {
            _ = MessageWindowTools.Show(s, messageType: MessageType.警告);
        }

        public static void ShowWarningMessageBox(this string s)
        {
            _ = MessageBox.Show(s, "警告", MessageBoxButton.OK, MessageBoxImage.Warning);
        }
    }
}
